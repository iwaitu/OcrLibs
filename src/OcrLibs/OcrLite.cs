...
namespace OcrLiteLib
{
    public class OcrLite
    {
        ...
        public OcrResult Detect(Mat img, int padding = 0, int maxSideLen = 512, float boxScoreThresh = 0.7f, float boxThresh = 0.3f,
                              float unClipRatio = 1.5f, bool doAngle = true, bool mostAngle = false)
        {
            Mat originSrc = img.Clone();
        ...
        public OcrResult Detect(string img, int padding = 0, int maxSideLen = 512, float boxScoreThresh = 0.7f , float boxThresh = 0.3f,
                              float unClipRatio = 1.5f, bool doAngle = true, bool mostAngle = false)
        {
